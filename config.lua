...
Config.Translate = {
	["EN"] = {
		...
		['robbery_timer'] = 'store robbery: remaning seconds ',
		['recently_robbed'] = 'this store was recently been robbed. Please wait some seconds ',
		['started_to_rob'] = 'you started to rob',
		['alarm_triggered'] = 'the alarm has been triggered',
		['robbery_complete'] = 'The robbery has been successful, you stole $',
		['robbery_cancelled'] = 'the robbery has been cancelled!',
		['min_police'] = 'Not Enough Police '..Config.PoliceNumberRequired..' Required',
		['robbery_already'] = 'A robbery is already in progress.',
		['no_threat'] = 'you do not pose a threat to the store keeper',
		['wait_time'] = 'Debes esperar ya fue reportado un robo recientemente y todas las tiendas fueron alvertidas',
	},

	["ES"] = {
		['shop_robbery'] = 'atraco a tienda',
		['press_to_rob'] = 'pulsa [E] para robar',
		['robbery_timer'] = 'atraco: segundos restantes',
		['recently_robbed'] = 'Esta tienda fue robada recientemente. por favor espere unos segundos ',
		['started_to_rob'] = 'has empezado a robar',
		['alarm_triggered'] = 'la alarma ha sido activada!',
		['robbery_complete'] = 'El robo salió bien, has robado $',
		['robbery_cancelled'] = 'el robo ha sido cancelado!',
		['min_police'] = 'No hay suficientes policia '..Config.PoliceNumberRequired..' son requeridos',
